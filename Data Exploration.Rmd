...
## Plot sdgs
```{r}
plot_sdg(df_sdgs %>% filter(!is.na(sdg)), systems = c("aurora", "elsevier", "siris", "ontology", "sdsn"))
```

## Correlation between systems
```{r}
cor_systems <- crosstab_sdg(df_sdgs %>% filter(!is.na(sdg)), systems = c("aurora", "elsevier", "siris", "ontology", "sdsn"))
